...
generate-docs:
	...
	KUBECONFIG="xxx" go run -ldflags '$(LDFLAGS)' redskyctl/main.go docs --directory docs/redskyctl
	go run -ldflags '$(LDFLAGS)' redskyctl/main.go docs --directory docs/api --source api --doc-type api
