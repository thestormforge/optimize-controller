...
manifests: controller-gen
	$(CONTROLLER_GEN) $(CRD_OPTIONS) rbac:roleName=manager-role webhook paths="./pkg/apis/...;./controllers/...;./pkg/webhook/...;./cmd/..." output:crd:artifacts:config=config/crd/bases
...
generate: controller-gen
	$(CONTROLLER_GEN) object:headerFile=./hack/boilerplate.go.txt paths="./pkg/apis/...;./controllers/...;./pkg/webhook/...;./cmd/..."
