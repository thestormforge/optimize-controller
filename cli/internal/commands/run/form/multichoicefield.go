...
import (
	...
	"github.com/thestormforge/optimize-controller/v2/cli/internal/commands/run/multichoiceinput"
)
...
func (m MultiChoiceField) Validate() tea.Cmd {
	values := m.Values()
	return func() tea.Msg { return m.Validator.ValidateMultiChoiceField(values) }
}
