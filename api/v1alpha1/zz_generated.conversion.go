...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ExperimentSpec)(nil), (*v1beta1.ExperimentSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ExperimentSpec_To_v1beta1_ExperimentSpec(a.(*ExperimentSpec), b.(*v1beta1.ExperimentSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.ExperimentSpec)(nil), (*ExperimentSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*Trial)(nil), (*v1beta1.Trial)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Trial_To_v1beta1_Trial(a.(*Trial), b.(*v1beta1.Trial), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.Trial)(nil), (*Trial)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*TrialSpec)(nil), (*v1beta1.TrialSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_TrialSpec_To_v1beta1_TrialSpec(a.(*TrialSpec), b.(*v1beta1.TrialSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.TrialSpec)(nil), (*TrialSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.TrialStatus)(nil), (*TrialStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha1_ExperimentSpec_To_v1beta1_ExperimentSpec(in *ExperimentSpec, out *v1beta1.ExperimentSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_TrialTemplateSpec_To_v1beta1_TrialTemplateSpec(&in.Template, &out.Template, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_ExperimentSpec_To_v1beta1_ExperimentSpec is an autogenerated conversion function.
...
func autoConvert_v1beta1_ExperimentSpec_To_v1alpha1_ExperimentSpec(in *v1beta1.ExperimentSpec, out *ExperimentSpec, s conversion.Scope) error {
	...
	out.Selector = in.Selector
	if err := Convert_v1beta1_TrialTemplateSpec_To_v1alpha1_TrialTemplateSpec(&in.Template, &out.Template, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta1_ExperimentSpec_To_v1alpha1_ExperimentSpec is an autogenerated conversion function.
...
// Convert_v1alpha1_Trial_To_v1beta1_Trial is an autogenerated conversion function.
...
// Convert_v1beta1_Trial_To_v1alpha1_Trial is an autogenerated conversion function.
...
// Convert_v1alpha1_TrialSpec_To_v1beta1_TrialSpec is an autogenerated conversion function.
...
// Convert_v1beta1_TrialSpec_To_v1alpha1_TrialSpec is an autogenerated conversion function.
...
// Convert_v1beta1_TrialStatus_To_v1alpha1_TrialStatus is an autogenerated conversion function.
