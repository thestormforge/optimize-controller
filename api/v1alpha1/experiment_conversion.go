...
func Convert_v1beta1_Metric_To_v1alpha1_Metric(in *v1beta1.Metric, out *Metric, s conversion.Scope) error {
	u, err := metric.ParseURL(in.URL)
	if err != nil {
		return err
	}
	if in.Type == v1beta1.MetricDatadog {
		out.Scheme = u.Query().Get("aggregator")
	} else {
		out.Scheme, out.Selector, out.Port, out.Path = u.Scheme, u.ForceSelector(), u.Port, u.Path
	}
