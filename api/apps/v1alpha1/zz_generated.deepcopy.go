...
func (in *Application) DeepCopyInto(out *Application) {
	*out = *in
	...
	if in.GoogleCloudPlatform != nil {
		in, out := &in.GoogleCloudPlatform, &out.GoogleCloudPlatform
		*out = new(GoogleCloudPlatform)
		**out = **in
	}
	if in.AmazonWebServices != nil {
		in, out := &in.AmazonWebServices, &out.AmazonWebServices
		*out = new(AmazonWebServices)
		**out = **in
	}
}
...
func (in *CostObjective) DeepCopyInto(out *CostObjective) {
	*out = *in
	...
	if in.PriceList != nil {
		in, out := &in.PriceList, &out.PriceList
...
func (in *LatencyObjective) DeepCopyInto(out *LatencyObjective) {
	*out = *in
	if in.LatencyTypes != nil {
		in, out := &in.LatencyTypes, &out.LatencyTypes
		*out = make([]LatencyType, len(*in))
		copy(*out, *in)
	}
}
